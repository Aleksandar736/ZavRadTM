    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            if (isset($_POST['change'])) {
                ...
                $novo_prez_kor = $_POST['novo_prez_kor'];
                $skrv_v = $_POST['skr_vred'];//Korisničko ime korisnika čije podatke menjamo

                //verifikacija forme
                $novo_prez_kor = test_input($novo_prez_kor);
                $skrv_v = test_input($skrv_v);	

                $upit = "UPDATE `korisnici` SET `prezime` = '".$novo_prez_kor."' WHERE `korisnicko_ime` = '".$skrv_v."'";
                ...
                echo "Izmenite prezime korisnika:";
                echo "</div>";
                echo "<div class='tekst-sadrzaja'>";
                echo "<fieldset class='fildset2'>";
                echo "<form name='edit_form' method='post' action='izmena_pre_kor.php'>";
                echo "<table border = '0' >";
                echo "<tr><td><b>Izmeni prezime korisnika:</b></td>";
                echo "<td colspan='3'><input name = 'novo_prez_kor' type = 'text' size='25' value = ''></td>";
