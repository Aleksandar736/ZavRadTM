    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            if (isset($_POST['change'])) {
                ...
                $nova_loz_kor = $_POST['nova_loz_kor'];
                $skrv_v = $_POST['skr_vred'];//Korisničko ime korisnika čije podatke menjamo

                //verifikacija forme
                $nova_loz_kor = test_input($nova_loz_kor);
                $skrv_v = test_input($skrv_v);	

                $upit = "UPDATE `korisnici` SET `lozinka` = '".$nova_loz_kor."' WHERE `korisnicko_ime` = '".$skrv_v."'";
                ...
                echo "Izmenite lozinku korisnika:";
                echo "</div>";
                echo "<div class='tekst-sadrzaja'>";
                echo "<fieldset class='fildset2'>";
                echo "<form name='edit_form' method='post' action='izm_loz_kor.php'>";
                echo "<table border = '0' >";
                echo "<tr><td><b>Izmeni lozinku korisnika:</b></td>";
                echo "<td colspan='3'><input name = 'nova_loz_kor' type = 'text' size='25' value = ''></td>";
