...
<head>
    ...
    <title>Čitanje pošte (menadžer)</title>
</head>
<body>
    <?php
    ...
    <div class="raspored-kolona">
        ...
        <div class="navigacija-sa-desne-strane">
            <table>
                ...
                <tr>
                    <td>            
                        <a href = "odg_na_e_pismo_men.php?key=<?php echo $salje_p; ?>"><button>Odgovori na <br/>e-pismo</button></a>
                    </td>
                </tr> 
                <tr>
                    <td>            
                        <a href = "bris_e_pisma_men.php?key=<?php echo $id_por; ?>"><button>Obriši <br/>e-pismo</button></a>
                    </td>
                </tr>            
                <tr>
                    <td>
                        <a href = "primlj_e_pisma_men.php"><button>Poštansko sanduče</button></a>
                    </td>
                </tr> 
            </table>
        </div>
