    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            if (isset($_POST['change'])) {
                ...
                $novi_ver_ko_kor = $_POST['novi_ver_ko_kor'];
                $skrv_v = $_POST['skr_vred'];//Korisničko ime korisnika čije podatke menjamo

                //verifikacija forme
                $novi_ver_ko_kor = test_input($novi_ver_ko_kor);
                $skrv_v = test_input($skrv_v);	

                $upit = "UPDATE `korisnici` SET `verifikacija` = '".$novi_ver_ko_kor."' WHERE `korisnicko_ime` = '".$skrv_v."'";
                ...
                echo "Izmenite verifikacioni kod korisnika:";
                echo "</div>";
                echo "<div class='tekst-sadrzaja'>";
                echo "<fieldset class='fildset2'>";
                echo "<form name='edit_form' method='post' action='izm_v_k_kor.php'>";
                echo "<table border = '0' >";
                echo "<tr><td><b>Izmeni verifikacioni kod korisnika:</b></td>";
                echo "<td colspan='3'><input name = 'novi_ver_ko_kor' type = 'text' size='25' value = ''></td>";
