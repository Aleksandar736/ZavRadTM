...
<head>
    ...
    <title>Čitanje poslate pošte (obični član tima)</title>
</head>
<body>
    <?php
    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            <div class="tekst-sadrzaja">
                ...
                //Namesta u bazi na 1 (umesto 0) u koloni pregl._po (pa se broj neproč. smanjuje za jedan (brojač ga ne broji))
        ...
        <div class="navigacija-sa-desne-strane">
            <table>
                <tr>
                    <td>            
                        <a href = "bris_e_pisma_po_clan.php?key=<?php echo $id_por; ?>"><button>Obriši <br/>e-pismo</button></a>
                    </td>
                </tr>            
                <tr>
                    <td>
                        <a href = "poslata_e_pisma_clan.php?key=<?php echo $id_por; ?>"><button>Poslata <br/>e-pisma</button></a>
                    </td>
                </tr> 
            </table>
        </div>
