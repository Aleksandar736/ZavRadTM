...
<head>
    ...
    <title>Odgovor na poslatu poruku (menadžer)</title>
</head>
<body>
    <?php
    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            <div class="oAplikaciji">
                ...
                if (isset($_POST['cancel'])) {
                    ...
                    echo "<td style='text-align:left'><input name = 'skr_im' type = 'hidden' value = $prim_aoc><h3 class='arial3' style='text-align: left'>".ucfirst($prim_aoc)."</h3></td></tr>";
                    echo "<tr><td><h3 class='arial3'>Naslov:</h3></td>";
                    echo "<td><input name = 'nasl' type = 'text' value = '' size = '49'></td></tr>";
                    echo "<tr><td colspan='2'><textarea name = 'poruka' rows = '15' cols = '59'></textarea></td></tr>";
                    echo "</td><td><input name = 'cancel' type = 'submit' class='dugmici' value = 'Otkaži'></td>";
                    echo "<td class='float-right'><input name = 'send' type = 'submit' class='dugmici' value = 'Pošalji'></td></tr>";
                    echo "</table>";    
                    echo "</form>";
                    echo "</div>"; 
                }	
        ...
        <div class="navigacija-sa-desne-strane">
            <table>
                ...
                <tr>
                    <td>            
                        <a href = "poslata_e_pisma_men.php"><button>Poslata <br/>e-pismo</button></a>
                    </td>
                </tr>            
            </table>
        </div>
