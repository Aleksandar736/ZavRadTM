    ...
    <div class="raspored-kolona">
        ...
        <div class="glavni-sadrzaj">
            ...
            <div class="tekst-sadrzaja">
                <?php
                //Tabela za dodavanje novog projekta idu ime i opis projekta
                echo "<div class='tabelaProPo'>";
                echo "<h3 class='dodavanjeNaslov'>Dodaj projekat:</h3>";//Naslov
                echo "</div>";
                echo "<div class='tekst-sadrzaja'>";
                echo "<fieldset class='fildset2'>";//Forma iz koje podaci idu na dodav_nov_proj_dod.php
                echo "<form name='add_form' method='post' action='dodav_nov_proj_dod.php'>";
                echo "<table border = '0' >";
                echo "<tr><td><b>Projekat:</b></td>";//Ime projekta
                echo "<td colspan='3'><input name = 'ime_proje' type = 'text' size='24' value = ''></td>";
                echo "</tr>";
                echo "<tr><td style='text-align: right'><b>Opis:</b></td>";//Opis projekta
