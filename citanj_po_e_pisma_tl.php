...
<head>
    ...
    <title>Čitanje poslate pošte (tim lider)</title>
</head>
<body>
    <?php
    ...
    <div class="raspored-kolona">
        ...
        <div class="navigacija-sa-desne-strane">
            <table>
                <tr>
                    <td>            
                        <a href = "bris_e_pisma_po_tl.php?key=<?php echo $id_por; ?>"><button>Obriši <br/>e-pismo</button></a>
                    </td>
                </tr>            
                <tr>
                    <td>
                        <a href = "poslata_e_pisma_tl.php?key=<?php echo $id_por; ?>"><button>Poslata <br/>e-pisma</button></a>
                    </td>
                </tr> 
            </table>
        </div>
