...
<head>
    ...
    <title>Poslate poruke (tim lider)</title>
</head>
<body>
    <?php
            ...
            <div class="dodavanjeNaslov">
                ...
                <div class="tekst-sadrzaja">
                    ...
                    while ($red = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>";
                        if($preg == 0){
                            echo "<td align = 'center' width = '1'><a href = 'citanj_po_e_pisma_tl.php?key=".$id_por."'><img src = 'images/unopened-mail.png' border = '0'></img></a></td>";
                        }
                        else{
                            echo "<tr><td align = 'center' width = '1'><a href = 'citanj_po_e_pisma_tl.php?key=".$id_por."'><img src = 'images/openmail.png' border = '0'></img></a></td>";
                        }
                        ...
                        echo "<a href = 'bris_e_pisma_po_tl.php?key=".$id_por."'><img src = 'images/mail_delete.png' border = '0'></img></a></td>";
                        echo "</tr>";
                    }
                    ?>
                    </table>
